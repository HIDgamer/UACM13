...
GLOBAL_LIST_INIT(ROLES_MISC, list(JOB_SYNTH, JOB_SYNTH_K9, JOB_WORKING_JOE, JOB_CORPORATE_LIAISON, JOB_COMBAT_REPORTER, JOB_MESS_SERGEANT, JOB_WO_CORPORATE_LIAISON, JOB_WO_SYNTH))
